            ...
            <div className="flex flex-col gap-8">
              <div className="flex flex-col items-center justify-center gap-3">
                ...
                <Button
                  ...
                  className="mx-auto text-white/80 border-[1px] border-white/40 bg-black w-fit hover:bg-gradient-to-r  from-[#ff8660]  to-[#d5491d] hover:text-white cursor-pointer hover:transition-transform hover:scale-105 "
                >
                  {showDetail ? "Hide project detail" : "Show project detail"}
                </Button>
              </div>
              {showDetail && (
                <div>
